...
from src.api.routes.series_history import router as series_history_router
from src.api.routes.series_live import router as series_live_router
...
router.include_router(series_history_router)
router.include_router(series_live_router)
