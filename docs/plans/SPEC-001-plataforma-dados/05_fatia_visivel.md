...
| **D5.6** | a paleta passa nos dois modos, com 4 papéis | `validate_palette.js` | `#2a78d6 ↔ #eb6834` **PASS** (protan ΔE 24,7/26,8) · `#d03b3b ↔ #eb6834` **FAIL** em ΔE **10,8** ⇒ **não coexistem** |
