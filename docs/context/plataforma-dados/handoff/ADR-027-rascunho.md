...
**Data:** 2026-09-04 · **Status:** aprovado pelo owner (D1 e D2, 2026-09-04) · **SPEC:** [`SPEC-001`](../specs/SPEC-001-plataforma-dados.md) (nenhuma seção específica — ver "Por que não é emenda de outra ADR" abaixo)
...
[`docs/context/plataforma-dados/handoff/proposta-topologia-ingest.md`](proposta-topologia-ingest.md)
...
- O canal de alarme externo (`Q3`, ainda aberta — `T-07.11` já tem o detector pronto, só falta o
  ...
  [`tasks-candidatas-fiacao-producao.md`](tasks-candidatas-fiacao-producao.md) para a correção
  desse ponto em relação ao handoff original.
