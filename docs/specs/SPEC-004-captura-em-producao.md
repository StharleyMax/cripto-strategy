...
**Status:** `SPEC_APPROVED` (em 2026-09-07) → **Estado: ver `harness pipeline state captura-em-producao` (em 2026-09-26: `DONE`)** `[MEDIDO 2026-09-26: harness pipeline state captura-em-producao]` — `approve spec` do **owner** em `2026-09-07T18:23:31Z`, `P1–P10` nos defaults do cabeçalho (`harness pipeline show captura-em-producao`); o estado corrente **é sempre** `harness pipeline state captura-em-producao`, e este texto não o substitui.
