...
**Data:** 2026-09-04 · **Status:** `aceito` (`approve spec` do owner em `2026-09-05T12:53:22Z` — `harness pipeline show camada-de-leitura-do-painel`; estado corrente sempre por `harness pipeline state camada-de-leitura-do-painel`, ledger é a identidade, não este texto) · **SPEC:** [`SPEC-003`](../specs/SPEC-003-camada-de-leitura-do-painel.md) §3.4–§3.5 · **PRD:** [`PRD-003`](../specs/PRD-003-camada-de-leitura-do-painel.md) `RF-5`..`RF-8`, `RNF-3`, `RNF-5`, `RN-6`, `RN-9`, `CA-F1-12`, `CA-F2-1`..`CA-F2-9`
