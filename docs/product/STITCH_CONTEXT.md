...
**CANDIDATA da `S2` em panes empilhados (feature `paineis-de-fluxo`, 2026-09-23): `bc317e03a98c4d5998a7eae94c695a34`** — `S2 Símbolo — Painel Multi-Série (7 Panes)`, `x=6080`, bifurcada de `8174…` · **`NEEDS_FIX` pelo gate `ux-ui-mastery` (5.9/10, 10 must-fix)** · **NÃO é canônica**: a `S2` canônica continua `8174…` até um veredito `APPROVED` `[MEDIDO: get_project.screenInstances + list_screens, 2026-09-23]`. Decisões, veredito e `[NÃO SEI]`: [`docs/context/paineis-de-fluxo/handoff/DESIGN-LAYOUT.md`](../context/paineis-de-fluxo/handoff/DESIGN-LAYOUT.md). ⚠️ A contagem de telas acima (**7**) envelheceu de novo: **13** telas em 2026-09-23 `[MEDIDO: list_screens]`. Entrada de §4 **proposta, não escrita** (`R6`).
