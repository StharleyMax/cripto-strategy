 ...
 * renders the specific cause through `SourceState`/`PainelClient.tsx` instead. Anything that
...
export default function PainelError({ reset }: { readonly error: Error & { digest?: string }; readonly reset: () => void }) {
  return (
